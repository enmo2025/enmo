...
export interface Event {
    ...
    date: string;
    location: string;
    eventDetailBanner: StaticImageData;
    content: string;
...
for (let i = 0; i < 100; i++) {
    events.push({
        id: `${i}`,
        title: "くらしの窓口名 " + i,
        description: "カラオケ好きさん、集まれ！！ 懐メロやアニメソングなど、ジャンルは問いません。 歌だけでなく、まったりトークも楽しみましょう🎤✨ くらしの窓口開催は平日、場所は春日部駅近辺のカラオケボックスを予定(駐車場あり) 入会希望の方は、承認後みんなの話題からカキコミしてくださいね！ 歌を愛する方のご参加を",
        eventBanner: eventBanner,
        brandLogo: brandLogo,
        brandName: "河部さん",
        participantFee: "¥1000 " + i,
        date: "2025/02/25",
        location: "オンライン",
        eventDetailBanner: eventDetailBanner,
        content: `
        ...
        host: {
            ...
            description: "こんにちは、川辺です！自然豊かな場所でのんびり過ごすこと、そして美味しいものを食べることが大好きです。この場所を訪れる皆さんが、心からリラックスして、忘れられない思い出を作れるよう、心を込めておもてなしさせていただきます。地元の隠れた名所や、とっておきのグルメ情報などもお気軽にお声がけくださいね。",
            hostName: "斎藤 昭夫"
        },
